...
/// Use `PortalConfig::default()` value if no config or args
#[test]
fn jump_no_args() {
    let mut runner = RUNNER.clone();
    let mut cmd = runner.arg("jump").capture_stdout().run();
